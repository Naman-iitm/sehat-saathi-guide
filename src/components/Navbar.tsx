...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md shadow-sm">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <Link to="/" className="flex items-center gap-3">
                <div className="w-12 h-12 bg-gradient-to-br from-primary to-chart-2 rounded-xl flex items-center justify-center shadow-md">
      ...
      {/* Navigation Row */}
      <div className="hidden lg:block bg-white/50 border-b border-gray-100/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
