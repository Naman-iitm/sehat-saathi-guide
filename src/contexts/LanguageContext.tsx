...
export type Language = 'hi' | 'en' | 'bn' | 'mr' | 'bho' | 'mai' | 'or';
...
const translations: Record<Language, Translations> = {
  ...
  or: {
    appName: 'ସ୍ୱାସ୍ଥ୍ୟ ସାଥୀ',
    home: 'ହୋମ',
    symptomTracker: 'ଲକ୍ଷଣ ଟ୍ରାକର',
    healthTips: 'ସ୍ୱାସ୍ଥ୍ୟ ଟିପ୍ସ',
    medicineStore: 'ଔଷଧ ଦୋକାନ',
    aiAssistant: 'AI ସହାୟକ',
    sarkariYojana: 'ସରକାରୀ ଯୋଜନା',
    nearbyHospitals: 'ପାଖାପାଖି ହସ୍ପାତାଲ',
    myProfile: 'ମୋ ପ୍ରୋଫାଇଲ',
    login: 'ଲଗଇନ',
    register: 'ପଞ୍ଜିକରଣ',
    logout: 'ଲଗଆଉଟ',
    loading: 'ଲୋଡ୍ ହୋଇଛି...',
    addSymptom: 'ଲକ୍ଷଣ ଯୋଡ଼ନ୍ତୁ',
    symptomName: 'ଲକ୍ଷଣର ନାମ',
    symptomDescription: 'ବିବରଣୀ (ଇଚ୍ଛାକୃତ)',
    addedOn: 'ଯୋଡ଼ା ହୋଇଛି',
    noSymptoms: 'କୌଣସି ଲକ୍ଷଣ ଯୋଡ଼ା ହୋଇନାହିଁ',
    emptySymptomError: 'ଦୟାକରି ଲକ୍ଷଣର ନାମ ଦିଅନ୍ତୁ',
    search: 'ଖୋଜନ୍ତୁ',
    addToCart: 'କାର୍ଟରେ ଯୋଡ଼ନ୍ਤୁ',
    cart: 'କାର୍ଟ',
    checkout: 'ଚେକଆଉଟ',
    total: 'ମୋଟ',
    address: 'ଠିକଣା',
    payment: 'ଭୁଗତାନ',
    proceedToPayment: 'ଭୁଗତାନ କରନ୍ਤୁ',
    orderPlaced: 'ଅର୍ଡର ହୋଇଛି',
    askHealth: 'ଆପଣଙ୍କ ସ୍ୱାସ୍ଥ୍ୟ ସମସ୍ୟା ବିଷୟରେ କୁହନ୍ਤୁ...',
    send: 'ପଠାନ୍ਤୁ',
    welcomeMessage: 'ନମସ୍କାਰ! ମୁଁ ଆପଣଙ୍କ ସ୍ୱାସ୍ଥ୍ୟ ସହାୟକ। ଆପଣଙ୍କ କେଉଁ ସମସ୍ୟା ଅଛି?',
    healthTipsTitle: 'ସ୍ୱାସ୍ଥ୍ୟ ଟିପ୍ସ',
    governmentSchemes: 'ସରକାରୀ ଯୋଜନା',
    freeHealthcare: 'ମୁକ୍ତ ସ୍ୱାସ୍ଥ୍ୟ ସେବା',
    schemes: 'ଯୋଜନା',
    eligibility: 'ଯୋଗ୍ୟତା',
    apply: 'ଆବେଦନ କରନ୍ਤୁ',
    email: 'ଇମେଲ',
    password: 'ପାସୱାର୍ଡ',
    otp: 'OTP',
    verifyOtp: 'OTP ଯାଞ୍ଚ କରନ୍ਤୁ',
    name: 'ନାମ',
    phone: 'ଫୋନ ନମ୍ବର',
    selectLanguage: 'ଭାଷା ବାଛନ୍ਤୁ',
    changeLanguage: 'ଭାଷା ବଦଲନ୍ਤୁ',
    price: 'ମୂଲ୍ୟ',
    quantity: 'ପରିମାଣ',
    remove: 'ହଟାନ୍ਤୁ',
    emptyCart: 'କାର୍ଟ ଖାଲି ଅଛି',
    continueShopping: 'କ୍ରୟ ଜାਰୀ ରଖନ୍ਤୁ',
    viewCart: 'କାର୍ଟ ଦେଖନ୍ਤୁ',
    fullName: 'ପୂର୍ଣ ନାମ',
    streetAddress: 'ଠିକଣା',
    city: 'ସହର',
    pincode: 'ପିନକୋଡ',
    paymentMethod: 'ଭୁଗତାନ ପଦ୍ଧତି',
    cod: 'କ୍ୟাশ ଅନ ଡେଲିଭରୀ',
    upi: 'UPI',
    placeOrder: 'ଅର୍ଡର କରନ୍ਤୁ',
    orderSuccess: 'ଅର୍ଡର ସଫଳ!',
    backToHome: 'ହୋମକୁ ଫେରନ୍ਤୁ',
    description: 'ବିବରଣୀ',
    date: 'ତାରିଖ',
    time: 'ସମୟ',
    deleteSymptom: 'ହଟାନ୍ਤୁ',
    quickLinks: 'ତ୍ୱରିତ ଲିଙ୍କ',
    legal: 'ଆଇନ',
    privacyPolicy: 'ଗୋପନୀୟତା ନୀତି',
    termsConditions: 'ନିୟମ ଓ ସର୍ତ୍ତ',
    support: 'ସହାୟତା',
    helpCenter: 'ସହାୟତା କେନ୍ଦ୍ର',
    feedback: 'ମତାମତ',
    contact: 'ଯୋଗାଯୋଗ କରନ୍ਤୁ',
    followUs: 'ଆମକୁ ଅନୁସରଣ କରନ୍ਤୁ',
    rightsReserved: 'ସମସ୍ତ ଅଧିਕਾਰ ସୁରକ୍ଷିତ',
    offers: 'ଅଫର',
    invalidEmail: 'ଅବୈଧ ଇମେଲ',
    newsletterTitle: 'ନ୍িঊଜଲେଟର',
    subscribeError: 'ସଦସ୍ୟତା ତ୍ରୁଟି',
    subscribeSuccess: 'ସଦସ୍ୟତା ସଫଳ',
    stayUpdated: 'ଆମର ସର୍ବଶେଷ ସ୍ୱାସ୍ଥ୍ୟ ଟିପ୍ସ ଏବଂ ବୈଶିଷ୍ଟ୍ୟ ସହିତ ଅପଡେଟ୍ ରହନ୍ਤୁ।'
  },
};
